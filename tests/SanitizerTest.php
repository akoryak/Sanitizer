...
class SanitizerTest extends PHPUnit_Framework_TestCase
{
	...
	/**
     * @covers Sanitizer::checkEmail
     */
    public function testCheckEmail()
    {
		// valid
        $email = 'test@mail.ca';
        $result = $this->instance->checkEmail($email);
		$this->assertEquals($email, $result);

		// invalid
        $result = $this->instance->checkEmail('test@mail.');
        $this->assertFalse($result);
    }
	
	
    /**
     * @covers  Sanitizer::arrayOfInts
     */
